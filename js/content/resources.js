...
// Crisis & support resources (plan §13.5). Top-listed: Parents Beyond Breakup.
window.GardenContent.resources = [
  { id: "pbb-helpline", name: "Parents Beyond Breakup helpline", number: "1300 853 437",
    href: "tel:1300853437", note: "365 days a year. Free, confidential, peer-based. For separating mums, dads & grandparents.", always24: false, top: true },
  ...
  { id: "pbb-separation-checklist", name: "Separation checklist", href: "https://www.parentsbeyondbreakup.com/get-support/separation-checklist",
    note: "A practical 'get in order' list.", external: true },
  ...
  { id: "1800respect", name: "1800RESPECT", number: "1800 737 732", href: "tel:1800737732",
    note: "National sexual assault, domestic & family violence counselling.", always24: true },
  { id: "lifeline", name: "Lifeline", number: "13 11 14", href: "tel:131114",
    note: "Crisis support & suicide prevention.", always24: true },
...
window.GardenContent.nonAffiliation = "The Garden is independent and not affiliated with Parents Beyond Breakup or any listed service; these links are included because they're the right people to call. No money changes hands.";
